...
public class Tombstone extends BaseMonster {
    ...
    private final int spriteOffset = rngGenerator.nextInt(0, 5);

    public Tombstone(double charPosx, double charPosy, Level level) {
        ...
        getImageView().setViewport(new Rectangle2D(TILE_WIDTH * spriteOffset, TILE_HEIGHT * 3, TILE_WIDTH, TILE_HEIGHT));
