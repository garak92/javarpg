...
public class Statue extends BaseMonster {
    private static final EnumMonsterAlignment alignment = EnumMonsterAlignment.PROP;
    private final int TILE_HEIGHT = 64;
    private final int TILE_WIDTH = 32;
    private final int spriteOffset = (int) (Math.random() * 5);

    public Statue(double charPosx, double charPosy, Level level) {
        ...
        getImageView().setViewport(new Rectangle2D(TILE_WIDTH * spriteOffset, 32 * 9, TILE_WIDTH, TILE_HEIGHT));
