...
public class Stable extends BaseMonster {
    ...
    public Stable(double charPosx, double charPosy, Level level) {
        ...
        getImageView().setViewport(new Rectangle2D(TILE_WIDTH * 3, TILE_HEIGHT * 4, TILE_WIDTH, TILE_HEIGHT));
