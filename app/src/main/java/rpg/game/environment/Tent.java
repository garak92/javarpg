...
public class Tent extends BaseMonster {
    ...
    private final int spriteOffset = rngGenerator.nextInt(8, 11);

    public Tent(double charPosx, double charPosy, Level level) {
        ...
        getImageView().setViewport(new Rectangle2D(TILE_WIDTH * 5, TILE_HEIGHT * spriteOffset, TILE_WIDTH, TILE_HEIGHT));
