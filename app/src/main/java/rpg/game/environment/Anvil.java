...
public class Anvil extends BaseMonster {
    ...
    private final int spriteOffset = rngGenerator.nextInt(8, 10);

    public Anvil(double charPosx, double charPosy, Level level) {
        ...
        getImageView().setViewport(new Rectangle2D(TILE_WIDTH * spriteOffset, TILE_HEIGHT * 13, TILE_WIDTH, TILE_HEIGHT));
