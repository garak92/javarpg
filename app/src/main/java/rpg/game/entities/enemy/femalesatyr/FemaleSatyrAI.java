...
public class FemaleSatyrAI extends BaseEnemyAI {
    private final int attackCoolDown = 20;
    private int randomAttackAccumulator = 0;

    public FemaleSatyrAI(BaseMonster monster) {
    ...
    public void attack() {
        if (randomAttackAccumulator == attackCoolDown) {
            ...
            monster.getLevel()
                    .addThing(new FemaleSatyrFireball(monster.getImageView().getBoundsInParent().getCenterX(),
